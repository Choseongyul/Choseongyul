## 안녕하세요👋 질문하는 블루팀 엔지니어 조성열입니다.
> 공격 위협 대응의 시작은 질문하는 것이라고 생각합니다. 따라서 저는 사소한 것이라도 근원적 물음을 가지는 것이 중요하다고 생각합니다.
> 프로젝트 수행시 도구 선정할 때나, 새로운 문제를 직면했을 때, 학생들을 위한 강의와 봉사를 통해 누군가 도왔던 순간에도 저는 질문을 통해 문제를 정의하고 해결하고자 노력했습니다. 
> 현재까지 발생했던 보안 위협들도 하나하나의 질문이 쌓여 대응 체계가 만들어졌듯이, 새로운 보안 위협도 질문을 통해 문제를 정의하고 해결할 수 있을거라고 생각합니다.

## My Interest 📚
![IR](https://img.shields.io/badge/IR_(Incident_Response)-E02424?style=for-the-badge)
![Detection](https://img.shields.io/badge/DETECTION-5849BE?style=for-the-badge)
![Analysis](https://img.shields.io/badge/ANALYSIS-F46800?style=for-the-badge)
![eBPF](https://img.shields.io/badge/eBPF-FFBF00?style=for-the-badge&logoColor=black)
![KUBERNETES](https://img.shields.io/badge/KUBERNETES-326CE5?style=for-the-badge)
![Docker](https://img.shields.io/badge/DOCKER-2496ED?style=for-the-badge)


## Price
> 토스뱅크 사이버보안 엔지니어 부트캠프 최우수 수료생 선발</br>
> 교육기간: 2025.09 ~ 2026.02
<img src="https://github.com/user-attachments/assets/7e2ae537-6d48-4a4d-b5ad-5759b6888740" height="500"/>

## Project

### 1. (Team) KERNEL: K8s Evidence Reconstruction & Network Event Ledger (2025.12 ~ 2026.01)
> 프로젝트 주제: 쿠버네티스 환경에서 위협 행위에 대한 탐지 및 분석 고도화 </br>
...
### 2. (Personal) MCP를 활용한 공격 시나리오 생성 에이전트 (2025.12)
> 프로젝트 주제: 공격 시나리오 다양성 확보를 위한 MITRE ATT&CK 기반 킬체인 생성 에이전트

#### Tech Stack
<img src="https://images.squarespace-cdn.com/content/v1/5ab952d7506fbeaa1f512f11/1586076420678-9G5MBZOQJLH0WXKP42V3/5bfdce88cd3820f7c5c21e02_mitre.png?format=1500w" height="28" /> ![MITRE ATT&CK](https://img.shields.io/badge/-MITRE_ATT%26CK-E02424?style=for-the-badge&logoColor=black)
![Python](https://img.shields.io/badge/PYTHON-3776AB?style=for-the-badge&logo=python&logoColor=white)
<img src="https://cline.bot/assets/branding/favicons/favicon-256x256.png" height="28" /> ![CLINE](https://img.shields.io/badge/-CLINE-6633EE?style=for-the-badge)
